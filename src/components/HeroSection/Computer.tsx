export const Computer = ({ budget }: any) => {
  return (
    <div className='lg:items-end overflow-x-hidden md:h-screen'>
      {budget ? (
        ...
        <div className='relative'>
          ...
          {/* React icon */}
          <div className='absolute w-16 bg-white rounded-md drop-shadow-sm border border-gray-50 p-1 top-20 lg:top-20 right-0 lg:right-10 drop-shadow-sm float fade-in-right'>
